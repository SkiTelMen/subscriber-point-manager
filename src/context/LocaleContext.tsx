...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    cancel: "Cancel",
    add: "Add",
    noContracts: "No contracts yet. Create one to add subscriber points.",
    noSubscriberPoints: "No subscriber points yet.",
  },
  ru: {
    dashboard: "Главная",
    ...
    cancel: "Отмена",
    add: "Добавить",
    noContracts: "Пока нет договоров. Создайте договор, чтобы добавить абонентские точки.",
    noSubscriberPoints: "Пока нет абонентских точек.",
  }
};
